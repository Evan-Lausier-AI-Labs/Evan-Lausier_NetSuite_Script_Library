...
*
* Note (2026-03-19): Retained Earnings roll-forward ($122.5M variance on accounts 3005,
* 350005, 350015) is being resolved by GTF running NetSuite year-end close for FY2023 and
* FY2024, which will physically post closing JEs to account 350005. The synthetic
* roll-forward approach is preserved on branch feature/re-rollforward-synthetic for
* reference or future use if year-end close is not run for a given period.
*/
