...
define(['N/query', 'N/file', 'N/runtime', 'N/log'], (query, file, runtime, log) => {
   ...
   *
   * Self-correcting: once NetSuite year-end close is run for a given year,
   * closing JEs zero out the IS account balances for that year, causing
   * this query to return 0 for it automatically -- no double-counting.
   *
